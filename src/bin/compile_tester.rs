            ...
            && device.usage() == 1
        {
            ...
            mac.add_frame(MacroFrame {
                action: macro_parser::ActionType::Loop(
                    vec![
                        MacroFrame {
                            action: ActionType::Loop(vec![MacroFrame {action: macro_parser::ActionType::ConsumerPress(Consumer::VolumeIncrement, Duration::from_millis(100)), delay: Duration::from_millis(100)}], Duration::ZERO, 5),
                            delay: Duration::ZERO,
                        },
                        // MacroFrame {
                        ...
                        // },
                        MacroFrame {
                            action: ActionType::Loop(vec![MacroFrame {action: macro_parser::ActionType::ConsumerPress(Consumer::VolumeDecrement, Duration::from_millis(100)), delay: Duration::from_millis(100)}], Duration::ZERO, 5),
                            delay: Duration::ZERO,
                        },
                    ],
                    Duration::ZERO,
